                ...
                <FormControl>
                  <div className="relative w-full h-full">
                    <FormLabel className="absolute left-4 top-2/4 -translate-y-2/4">
                      <BiSolidUser className="w-6 h-6 text-gray-400" />
                    </FormLabel>
                    <Input
                      type="text"
                      autoComplete="off"
                  ...
                  <div className="relative w-full h-full">
                    ...
                    <div>
                      ...
                      <Button
                        type="button"
                        variant="ghost"
                        className="absolute top-2/4 -translate-y-2/4 right-2 cursor-pointer hover:bg-transparent dark:hover:bg-transparent"
                      ...
                      {field.value && (
                        <div className="absolute bottom-[0px] w-full">
                          <div className="relative mx-auto w-[92%]">
                            <div className="w-full bg-gray-200 dark:bg-[#333] rounded-full h-[4px]">
                                <div
